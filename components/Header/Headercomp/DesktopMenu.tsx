    ...
    <div className="font-mono text-xs md:flex hidden flex-row items-center space-x-8 ">
      ...
      >
        <ReactScrollLink to="WhereIhaveWorkedSection" spy={true} smooth={true} offset={-300} duration={200}>
          &gt; 02.{" "}
          <span className="text-white  hover:cursor-pointer hover:text-AAsecondary duration-300">Achievements</span>
        </ReactScrollLink>
      </motion.div>
      <motion.div
        initial={{
        ...
        className="text-AAsecondary"
      >
        <ReactScrollLink to="SomethingSection" spy={true} smooth={true} offset={-100} duration={200}>
      ...
      <motion.span
        ...
        className="text-AAsecondary"
      >
         <ReactScrollLink to="CertificatesSection" spy={true} smooth={true} offset={-100} duration={200}>
         &gt; 04. <span className="text-white  hover:cursor-pointer hover:text-AAsecondary duration-300">Certifications</span>
        </ReactScrollLink>
      </motion.span>
      <motion.span
        initial={{
